      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-6">
          ...
          <div class="small-box bg-danger">
            ...
            <a href="#" 
            data-toggle="modal"
            data-target="#modalTunggakan" class="small-box-footer">Cetak <i class="fas fa-print"></i></a>
          </div>
        </div>
        <!-- ./col -->
      </div>
...
<div class="modal fade" id="modalTunggakan" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Pilih Batas Tunggakan</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form action="pdf/output/laporan_tunggakan.php" method="get" target="_blank">
          ...
          <label for="tanggal_jatuh_tempo">Tanggal Awal Periode </label>
...
<!-- modal Laporan Pembayran Per Siswa -->
