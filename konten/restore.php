...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Restore (ektensi.sql)</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="" enctype="multipart/form-data" method="post"><label for="file">File Backup</label>
                        <input type="file" name="file" class="form-control" required>
                        <button type="submit" class="btn btn-info btn-block mt-3" name="restore" onclick="return confirm('Perhatian !!!, proses restore aakan merubah total seluruh data yang ada berdasarkan file yang dipilih, sebelum rstore sangat disarankann untuk melakukan proses backup terlebih dahulu,Apakah anda sudah yakin akan melanjutkan proses ini?')"><i class="fas fa-cog">Mulai Restore</i></button>
                    </form>
                    <?php
