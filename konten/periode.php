                    ...
                    <table id="example1" class="table table-hover">
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <!-- tombol edit-->
                                    <a href="aksi/periode.php" data-toggle="modal" data-target="#modalUbah<?= $kolom['id_periode']; ?>">
                                        <i class="fas fa-edit"></i></a>
                                    &nbsp;
                                    <!-- tombl hapus -->
                                    <a onclick="return confirm('Yakin akan menghapus data ini?')" href="aksi/periode.php?aksi=hapus&id_periode=<?= $kolom['id_periode']; ?>">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="aksi/periode.php" method="post">
                                                ...
                                                $kolom['periode']; ?>" class="form-control" required>
                ...
                <table class="table table-hover">
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <a onclick="return confirm('Yakin akan Mengembalikan Data Ini?')" href="aksi/periode.php?aksi=restore&id_periode=<?= $kolom['id_periode']; ?>">
                                    <i class="fas fa-trash-restore"></i>

                                    <a onclick="return confirm('Yakin akan menghapus data ini secara permanent ?')" href="aksi/periode.php?aksi=hapus-permanen&id_periode=<?= $kolom['id_periode']; ?>">
