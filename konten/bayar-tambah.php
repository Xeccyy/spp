            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <input type="hidden" name="aksi" value="tambah">
                        ...
                        <select name="id_siswa" class="form-control select2bs4">
                            ...
                            <?php
                                ...
                                while($siswa=mysqli_fetch_array($query_siswa)){
                                    echo "<option value='$siswa[id_siswa]'>$siswa[nis]-$siswa[nama]($siswa[kelas])</opion>";
                                }
                            ?>
                        </select>
                        <label for="id_bayar_metode">Metode Pembayaran</label>
                        <select name="id_bayar_metode" class="form-control"><option value="id_bayar_metode">--Pilih Metode Pembayaran</option>
                            <?php
                        ...
                        <textarea name="keterangan" class="form-control" rows="3" placeholder="Isi Dengan keterangan pembayaran spserti nama bank,nama,pengirim,dll"></textarea>
