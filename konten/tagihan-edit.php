                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="aksi/tagihan.php" method="post">
                                ...
                                <input type="text" name="id_biaya" class="form-control" readonly value="<?= $tagihan['id_biaya']; ?>">
                                ...
                                if($tagihan['total_terbayar']>0){ ?> readonly <?php } ?> value="<?= $tagihan['tanggal_jatuh_tempo']; ?>">

                                <div class="row">
                                    <div class="col-md-4">
                                        <label for="jumlah_biaya">Total Tagihan</label>
                                        <input type="number" name="jumlah_biaya" class="form-control text-right" <?php
                                if($tagihan['total_terbayar']>0){ ?> readonly <?php } ?> value="<?= $tagihan['jumlah_biaya']; ?>">
                                    </div>
                                    <div class="col-md-4">
